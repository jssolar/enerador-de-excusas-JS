function Carrusel (){
    return (
        <div id="myCarousel" className="carousel slide mb-6 pointer-event" data-bs-ride="carousel" data-bs-theme="light">
      ...
      <div className="carousel-item">
        ...
        <div className="container">
          <div className="carousel-caption text-end">
            ...
            <p><a className="btn btn-lg btn-primary" href="#">Browse gallery</a> akskjdhas</p>
          </div>
        </div>
      </div>
    </div>
